...
const api: ElectronAPI = {
  ...
  window: {
    ...
    resizeStart: (edge, x, y) => ipcRenderer.send(CHANNELS.windowResizeStart, edge, x, y),
    resizeMove: (x, y) => ipcRenderer.send(CHANNELS.windowResizeMove, x, y),
    resizeEnd: () => ipcRenderer.send(CHANNELS.windowResizeEnd),
